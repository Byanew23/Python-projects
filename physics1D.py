...
10:05 PM Thu September 20, 2018

Noticed recently that control-s wasn't pausing execution in Windows. So, 
updated this script to include the pygame (keyboard) event handlers. 
This requires a little pygame window be displayed. This window is only 
used to enable these handlers. Use the p key to pause and resume. Use 
the x key to quit.
...
def main():  
    ...
    pygame.init()
    display_surface = pygame.display.set_mode((100, 1))
    ...
    car = {'x_m':3, 'v_mps':3.0, 'a_mps2':-3.0}
